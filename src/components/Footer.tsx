          ...
          <div className="flex flex-col items-start justify-start p-4 md:p-6 rounded-xl bg-gray-100 dark:bg-gray-950 shadow-lg"> {/* Changed bg-gray-900 to bg-gray-100 for light mode */}
            ...
            <div className="mt-4">
              <span className="text-xs text-red-500 block font-semibold">
                {currentLang === "hy"
                  ? "Զգուշացում. Կան կեղծ էջեր, որոնք ներկայացնում են որպես պաշտոնական: Ձեզ միայն այս կայքի և վերը նշված սոցիալական էջերի միջոցով է ուղարկվելու օրիգինալ ապրանք:"
                  : currentLang === "ru"
                  ? "Внимание: Существуют фальшивые сайты, выдающие себя за официальных поставщиков. Только этот сайт и указанные соцсети являются официальными."
