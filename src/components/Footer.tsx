...
const FooterNavCard = ({
  ...
  <section className="flex h-full flex-col gap-6 rounded-2xl border border-white/10 bg-white/5 p-6">
            ...
            <div className="flex flex-wrap gap-2">
              {combinedSocialLinks.map(link => (
                <InteractiveDiv
                  ...
                  className="flex h-10 w-10 items-center justify-center rounded-full border border-white/15 text-white transition-all duration-200"
                  aria-label={link.label}
                  whileHoverScale={1.05}
                  hoverShadow="none"
                  hoverY={0}
                  style={{ backgroundColor: link.color } as CSSProperties}
                >
