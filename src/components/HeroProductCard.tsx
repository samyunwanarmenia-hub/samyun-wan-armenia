...
const HeroProductCard: React.FC<HeroProductCardProps> = ({ t, openOrderModal }) => {
  ...
  return (
    <div className="relative">
      <motion.div 
        className="bg-gray-800 rounded-3xl p-8 shadow-2xl max-w-md mx-auto border border-gray-700" // Changed background and border to darker shades
      ...
      >
        <div className="relative">
          ...
          <div className="text-center mb-6">
            <h3 className="text-white text-3xl font-bold mb-2">{t.productShowcase[featuredProduct.labelKey]}</h3> {/* Changed text color to white */}
            <p className="text-gray-300 text-lg mb-3">{t.productShowcase[featuredProduct.descKey]}</p> {/* Changed text color to gray-300 */}
            <p className="text-green-400 text-3xl font-bold mb-6">{featuredProduct.price.toLocaleString()} AMD</p>
            <motion.button
