...
const FaqSection: React.FC<FaqSectionProps> = ({ t, isVisible }) => {
  ...
  return (
    <motion.section
      id="faq"
      className="relative py-16 bg-gray-100 text-gray-900 overflow-hidden"
    ...
    >
      ...
      <div className="container mx-auto px-4 max-w-3xl relative z-10">
        ...
        >
          ...
          {/* Removed the subtitle <p> tag that used t.faq.q1 */}
        </motion.div>
        ...
        <div className="space-y-3">
          {questions.map((q, index) => (
            ...
            >
              <motion.button
                className="flex justify-between items-center w-full p-5 text-left text-lg font-semibold text-gray-900 hover:bg-gray-100 transition-colors"
