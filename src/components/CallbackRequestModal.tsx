    ...
    >
      ...
      >
        ...
        <motion.div variants={itemVariants}>
          <label className="block text-gray-300 dark:text-gray-300 text-sm font-semibold mb-2"> {/* Changed text-gray-700 to text-gray-300 */}
          ...
          <div className="flex flex-col space-y-2">
            ...
            >
              <input
                ...
                required
              />
              <span className="ml-2 text-gray-200 dark:text-gray-200 text-base">{t.callbackRequest.weightGainOption}</span>
            </motion.label>
            <motion.label 
              className="inline-flex items-center"
              whileHover={{ scale: 1.02, x: 5 }}
            ...
            >
              <input
                ...
                required
              />
              <span className="ml-2 text-gray-200 dark:text-gray-200 text-base">{t.callbackRequest.weightLossOption}</span>
            </motion.label>
          </div>
        </motion.div>
          ...
          <div className="flex flex-col space-y-2">
            ...
            >
              <input
                ...
                required
              />
              <span className="ml-2 text-gray-200 dark:text-gray-200 text-base">{t.callbackRequest.purposeDetails}</span>
            </motion.label>
            <motion.label 
              className="inline-flex items-center"
              whileHover={{ scale: 1.02, x: 5 }}
            ...
            >
              <input
                ...
                required
              />
              <span className="ml-2 text-gray-200 dark:text-gray-200 text-base">{t.callbackRequest.purposeOrders}</span>
            </motion.label>
            <motion.label 
              className="inline-flex items-center"
              whileHover={{ scale: 1.02, x: 5 }}
            ...
            >
              <input
                ...
                required
              />
              <span className="ml-2 text-gray-200 dark:text-gray-200 text-base">{t.callbackRequest.purposeOther}</span>
            </motion.label>
          </div>
        </motion.div>
