    ...
    >
      {languages.map((lang) => (
        <motion.button
          ...
          className="text-sm text-gray-600 dark:text-gray-400 disabled:opacity-50 disabled:font-semibold disabled:text-primary-600 dark:disabled:text-primary-400 transition-colors" /* Changed text-gray-700 to text-gray-600 for light mode */
