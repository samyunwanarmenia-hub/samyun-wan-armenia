...
// const DynamicGradientBackground = dynamic(() => import('@/components/GradientBackground'), { ssr: false }); // Removed import
...
const MainLayout = ({
  ...
  return (
    <> {/* Use React.Fragment instead of a div */}
      {/* <DynamicGradientBackground /> Removed the new gradient background */}
