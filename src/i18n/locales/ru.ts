...
export const ru: TranslationKeys = {
  ...
  auth: {
    ...
    signInButton: 'Войти',
    socialSignIn: 'Войти через {{provider}}',
    signInLink: 'Уже есть аккаунт? Войти',
    signUpButton: 'Зарегистрироваться',
    socialSignUp: 'Зарегистрироваться через {{provider}}',
    signUpLink: 'Нет аккаунта? Зарегистрироваться',
    sendInstructions: 'Отправить инструкции по сбросу',
    forgotPasswordLink: 'Забыли пароль?',
    newPasswordLabel: 'Новый пароль',
    newPasswordPlaceholder: 'Введите новый пароль',
    updatePasswordButton: 'Обновить пароль',
    sendMagicLink: 'Отправить магическую ссылку',
    magicLinkText: 'Войти с помощью магической ссылки',
    phonePlaceholder: 'Введите номер телефона',
    tokenPlaceholder: 'Введите ваш OTP-токен',
    phoneLabel: 'Номер телефона',
    tokenLabel: 'Токен',
    verifyOtpButton: 'Подтвердить токен',
    verifyOtpLink: 'Уже есть токен? Подтвердить',
  },
  profile: {
    description: 'Управляйте данными своего профиля.',
    fetchError: 'Произошла ошибка при загрузке данных профиля.',
    updateSuccess: 'Профиль успешно обновлен.',
    updateError: 'Произошла ошибка при обновлении профиля.',
    notLoggedIn: 'Пожалуйста, войдите, чтобы просмотреть свой профиль.',
    firstNameLabel: 'Имя',
    firstNamePlaceholder: 'Введите ваше имя',
    lastNameLabel: 'Фамилия',
    lastNamePlaceholder: 'Введите вашу фамилию',
    avatarLabel: 'URL аватара',
    avatarPlaceholder: 'Введите URL вашего аватара',
    avatarHint: 'Используйте URL общедоступного изображения.',
    saving: 'Сохранение...',
