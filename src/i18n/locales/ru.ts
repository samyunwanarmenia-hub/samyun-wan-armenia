...
export const ru: TranslationKeys = {
  ...
  about: {
    ...
    mainAuthenticityHeader: 'Единственное место в Армении, где вы можете с уверенностью приобрести оригинальный Samyun Wan, с QR-кодом на каждой упаковке и гарантией подлинности продукта. Не рискуйте своим здоровьем с поддельными продуктами.',
    whyChooseUs: {
      title: 'Почему выбирают нас',
      originalProduct: 'Оригинальный продукт – Мы являемся официальным представителем Samyun Wan в Армении уже 6 лет.',
      safety: 'Безопасность – Каждая упаковка имеет QR-код, который позволяет проверить подлинность.',
      noFakeAdditives: 'Нет поддельных добавок – Только оригинальный продукт, никогда не содержит лекарств или вредных веществ.',
      customerTrust: 'Доверие клиентов – Наши клиенты получают безопасный и подлинный продукт.',
    },
    warningSection: {
      mainText: 'Рекомендуем покупать только у надежных продавцов. Присоединяйтесь к тем, кто выбирает настоящий и 100% оригинальный Samyun Wan с QR-кодом и безопасностью.',
      attention: 'ВНИМАНИЕ',
      ageRestriction: 'Продукт не является лекарственным средством и не предназначен для лиц младше 18 лет',
    },
  },
  benefits: {
  ...
  footer: {
    ...
    description: 'Единственное место в Армении, где вы можете с уверенностью приобрести оригинальный Samyun Wan, с QR-кодом на каждой упаковке и гарантией подлинности продукта. Не рискуйте своим здоровьем с поддельными продуктами.',
