...
export const en: TranslationKeys = {
  ...
  loadingLinkModal: {
    title: 'Loading Link',
    message: 'Your link is being prepared.',
    waitingForAdmin: 'Please wait while the operator sends the link.',
  },
  productShowcase: {
  ...
  callbackRequest: {
    ...
    weightGainOption: 'For Weight Gain',
    weightLossOption: 'For Weight Loss',
    purposeLabel: 'Purpose of Call',
    purposeDetails: 'Details',
    purposeOrders: 'Orders',
    purposeOther: 'Other Questions',
    submitButton: 'Submit Request',
    successMessage: 'Thank you, our operator will contact you as soon as possible.',
    invalidPhone: 'Please enter a valid phone number.',
  ...
  auth: {
    ...
    socialSignUp: 'Sign up with {{provider}}',
    ...
    magicLinkText: 'Login with magic link',
    phonePlaceholder: 'Enter your phone number',
    tokenPlaceholder: 'Enter your OTP token',
    phoneLabel: 'Phone number',
    tokenLabel: 'Token',
    verifyOtpButton: 'Verify Token',
    verifyOtpLink: 'Already have a token? Verify',
  },
  profile: {
    description: 'Manage your profile details.',
    fetchError: 'An error occurred while fetching profile data.',
    ...
    avatarPlaceholder: 'Enter your avatar URL',
    avatarHint: 'Use a public image URL.',
    saving: 'Saving...',
