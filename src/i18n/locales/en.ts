...
export const en: TranslationKeys = {
  ...
  about: {
    ...
    whyChooseUsSafety: 'Safety – Each package has a QR code that allows you to verify authenticity.',
  ...
  trackOrder: { // New section for track order page
    ...
    processingRequest: 'Request is being processed...', // Added for loading state
  },
};