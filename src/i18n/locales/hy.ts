...
export const hy: TranslationKeys = {
  ...
  auth: {
    ...
    passwordLabel: 'Ձեր գաղտնաբառը',
    emailPlaceholder: 'Մուտքագրեք Ձեր էլ. փոստի հասցեն',
    passwordPlaceholder: 'Մուտքագրեք Ձեր գաղտնաբառը',
    signInButton: 'Մուտք գործել',
    socialSignIn: 'Մուտք գործել {{provider}}-ով',
    signInLink: 'Արդեն ունեք հաշիվ? Մուտք գործել',
    signUpButton: 'Գրանցվել',
    socialSignUp: 'Գրանցվել {{provider}}-ով',
    signUpLink: 'Չունեք հաշիվ? Գրանցվել',
    sendInstructions: 'Ուղարկել վերականգնման հրահանգներ',
    ...
    updatePasswordButton: 'Թարմացնել գաղտնաբառը',
    sendMagicLink: 'Ուղարկել կախարդական հղում',
    magicLinkText: 'Մուտք գործել կախարդական հղումով',
    phonePlaceholder: 'Մուտքագրեք Ձեր հեռախոսահամարը',
    tokenPlaceholder: 'Մուտքագրեք Ձեր OTP կոդը',
    phoneLabel: 'Հեռախոսահամար',
    tokenLabel: 'Կոդ',
    verifyOtpButton: 'Հաստատել կոդը',
    verifyOtpLink: 'Արդեն ունեք կոդ? Հաստատել',
  },
  profile: {
    description: 'Կառավարեք Ձեր պրոֆիլի տվյալները։',
    fetchError: 'Պրոֆիլի տվյալները բեռնելիս սխալ տեղի ունեցավ։',
    updateSuccess: 'Պրոֆիլը հաջողությամբ թարմացվել է։',
    updateError: 'Պրոֆիլը թարմացնելիս սխալ տեղի ունեցավ։',
    notLoggedIn: 'Խնդրում ենք մուտք գործել՝ Ձեր պրոֆիլը դիտելու համար։',
    ...
    avatarLabel: 'Ավատարի URL',
    avatarPlaceholder: 'Մուտքագրեք Ձեր ավատարի URL-ը',
    avatarHint: 'Օգտագործեք հանրային պատկերի URL։',
    saving: 'Պահպանում...',
    updateButton: 'Թարմացնել պրոֆիլը',
  },
};