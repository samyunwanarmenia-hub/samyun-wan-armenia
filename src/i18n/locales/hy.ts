...
export const hy: TranslationKeys = {
  ...
  footer: {
    ...
    purchaseWarning: 'Խորհուրդ չի տրվում 14 տարեկանից ցածր անձանց :\nՁեր իսկ առողջության և անվտանգության նկատառումներից ելնելով , ՀՈՐԴՈՐՈՒՄ ԵՆՔ ԶԵՐԾ ՄՆԱԼ անհայտ ծագման ԻԲՐև ՎԿԱՅԱԳՐՎԱԾ ապրանքատեսակ գնելուց կամ օգտագրծելուց:\nԱհա մի քանի նշան թե ինչպե՞ս տարբերել կեղծ ապրանքատեսակը։',
